...
const string1 : string = "HTML";
const string2 : string = "CSS";
...
const mixedCaseString : string = "Web Developer.";
...
const Brand : string [] = ["Alkaram", "Khaadi", "SanaSafina's","AsimJofa", "GulAhmed"]
